 ...
 * @author Jatin Kamboj
 */
public class qryfle extends javax.swing.JFrame {

    /**
     * Creates new form qryfle
     */
    public qryfle() {
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        p_dtls = new javax.swing.JTextField();
        ...
        jPanel1.setToolTipText("Query File Management System");
        ...
        jLabel9.setText("Query File Management System");
        jLabel9.setToolTipText("Query File Management Systemment System");
        ...
        jLabel6.setToolTipText("Project Details");

        c_nm.setFont(new java.awt.Font("Baskerville Old Face", 1, 12)); // NOI18N
        c_nm.setForeground(new java.awt.Color(0, 102, 102));
        c_nm.setToolTipText("Enter Your Query Name");

        eml.setFont(new java.awt.Font("Baskerville Old Face", 1, 12)); // NOI18N
        eml.setForeground(new java.awt.Color(0, 102, 102));
        eml.setToolTipText("Enter Your E-Mail");

        p_dtls.setFont(new java.awt.Font("Baskerville Old Face", 1, 12)); // NOI18N
        p_dtls.setForeground(new java.awt.Color(0, 102, 102));
        p_dtls.setToolTipText("Enter Your Project Details");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(p_dtls, javax.swing.GroupLayout.PREFERRED_SIZE, 335, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(eml, javax.swing.GroupLayout.PREFERRED_SIZE, 335, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                            .addComponent(p_dtls, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        if((pid!="")&&(cnm!="")&&(pmd!="")&&(pdtl!="")){
            try{
                ...
                int a=stmt.executeUpdate("insert into QUERYFILE values('"+pid+"','"+cnm+"','"+pmd+"','"+pdtl+"')");
                con.close();
                ntf.setVisible(true);
    ...
    private void modifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyActionPerformed
        ...
        if((pid!="")&&(cnm!="")&&(pmd!="")&&(pdtl!="")){
            try{
                ...
                Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","resourcem","resourcem");
                Statement stmt=con.createStatement();
                int a=stmt.executeUpdate("update QUERYFILE set NAME='"+cnm+"',E_ID='"+pmd+"',PRO_DET='"+pdtl+"' where Q_ID='"+pid+"' ");
                con.close();
                ntf.setVisible(true);
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        ...
        if(pid!=""){
            try{
                ...
                Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","resourcem","resourcem");
                Statement stmt=con.createStatement();
                int a=stmt.executeUpdate("delete from QUERYFILE where Q_ID='"+pid+"'");
                ntf.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(qryfle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField p_dtls;
